var api = "http://pool.asecoin.io:8117";

var poolHost = "pool.asecoin.io";

var irc = "irc.freenode.net/#asecoin";

var email = "support@asecoin.io";

var cryptonatorWidget = ["{symbol}-BTC", "{symbol}-USD", "{symbol}-EUR"];

var easyminerDownload = "http://pool.asecoin.io/cryptonote-easy-miner_v0.0.3.zip";
